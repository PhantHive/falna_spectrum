...
PRO FALNA_ANALYSIS
	...
	; save fatigue FFT
    SET_PLOT, 'PS'
    DEVICE, FILENAME='E:\PROG\15-IDL\falna_spectrum\fft_analysis\spectrum\fatigue_fft.ps', /COLOR, XSIZE=25, YSIZE=12, /LANDSCAPE
    ...
    ; save floor FFT
    SET_PLOT, 'PS'
    DEVICE, FILENAME='E:\PROG\15-IDL\falna_spectrum\fft_analysis\spectrum\floor_fft.ps', /COLOR, XSIZE=25, YSIZE=12, /LANDSCAPE
